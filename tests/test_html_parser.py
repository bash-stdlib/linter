...
class TestHTMLParser(unittest.TestCase):
    ...
    def test_parse__single_function__extracts_correctly(self):
    ...
    def test_parse__multiple_functions__extracts_all_correctly(self):
    ...
    def test_parse__trailing_dot__strips_invalid_char(self):
    ...
    def test_parse__trailing_underscore__strips_invalid_char(self):
    ...
    def test_parse__non_stdlib_text__ignores_content(self):
    ...
    def test_parse__nested_tags__extracts_correctly(self):
    ...
    def test_parse__missing_sub_namespaces__ignores_incomplete_name(self):
