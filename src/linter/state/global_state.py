...
class GlobalLinterState:
    ...
    def __init__(
        ...
        self.extra_namespaces: Set[str] = (
            set(extra_namespaces) if extra_namespaces else set()
        )
        self.extra_functions: Set[str] = (
            set(extra_functions) if extra_functions else set()
        )
