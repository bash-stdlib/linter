...
class TestLineContinuationTransformer(unittest.TestCase):
    ...
    def test_transform__line_continuation__replaces_with_spaces_by_default(self) -> None:
        content = "echo \\\nhello"
    ...
    def test_transform__line_continuation__replaces_with_vtab_when_preserving(self) -> None:
        content = "echo \\\nhello"
    ...
    def test_transform__multiple_line_continuations__replaces_all_correctly(self) -> None:
        content = "echo \\\nhello \\\nworld"
