...
class TestExceptions(unittest.TestCase):
    def test_base_linter_exception__can_be_raised__captures_message(self) -> None:
    ...
    def test_empty_cache_error__is_subclass_of_base__correct_inheritance(self) -> None:
