...
class TestFilterRedirectsTokenIterator(unittest.TestCase):
    ...
    def test_iterator__standard_redirect__filters_out_redirect_and_target(
            self) -> None:
    ...
    def test_iterator__append_redirect__filters_out_redirect_and_target(
            self) -> None:
        tokens = ["arg1", ">>", "file", "arg2"]
        iterator = FilterRedirectsTokenIterator(tokens)
    ...
    def test_iterator__input_redirect__filters_out_redirect_and_target(
            self) -> None:
        tokens = ["arg1", "<", "file", "arg2"]
        iterator = FilterRedirectsTokenIterator(tokens)
    ...
    def test_iterator__here_string__filters_out_redirect_and_target(
            self) -> None:
    ...
    def test_iterator__fd_redirect__filters_out_fd_operator_and_target(
            self) -> None:
        # e.g. 2 > file
    ...
    def test_iterator__self_contained_fd_redirect__filters_out_token(
            self) -> None:
